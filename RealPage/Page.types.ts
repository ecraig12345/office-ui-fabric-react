...
export interface IPageProps {
  ...
  /** (9) Feedback section with GitHub issues. **/
...
export interface IPageSectionProps {
  ...
  // /** Page source code URL for editing Markdown. */
  // componentUrl?: string;
  ...
  renderAs?: IComponentAs<IPageSectionProps>;
}

export type TPlatformPageProps<TPlatforms extends string> = { [platform in TPlatforms]?: IPageProps };
