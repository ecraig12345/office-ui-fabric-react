  ...
  if (dos || donts) {
    dosAndDonts.push(
      <div className={css(styles.subSection, `Page-doDontSections`)} key="dosAndDonts">
          ...
          <div className={css(styles.sectionHeader, `Page-doSectionHeader`)}>
            ...
            {dos && componentUrl && (
              <EditSection
                ...
                url={getEditUrl({ name: fileNamePrefix || title, section: 'Dos', baseUrl: componentUrl })!}
              />
            )}
          </div>
          {dos !== undefined && (
        ...
        <div className={css(styles.doSection, `Page-doSection Page-doSection--dont`)}>
          <div className={css(styles.sectionHeader, `Page-doSectionHeader`)}>
            ...
            {donts && componentUrl && (
              <EditSection
                ...
                url={getEditUrl({ name: fileNamePrefix || title, section: 'Donts', baseUrl: componentUrl })!}
              />
            )}
          </div>
          {donts !== undefined && (
