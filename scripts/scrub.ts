...
function deleteIfSymlink(itemPath: string, failedPaths: string[]): void {
  try {
 ...
 */
function deleteNodeModulesSymlinks(packagePath: string, failedPaths: string[]): void {
...
function getChildren(parentFolder: string): string[] {
