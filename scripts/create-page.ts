...
// Error strings
const errorUnableToOpenTemplate = (templateFile: string) => `Unable to open mustache template ${templateFile} for page`;
...
function handleWriteFile(buffer: string, filePath: string, step: string) {
