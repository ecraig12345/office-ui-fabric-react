...
const newPackageName = (argv.name || argv._[0]) as string | undefined;
...
function performStep(stepIndex: number) {
...
function writeFileCallback(error: any, writeFileError: string, callback?: () => void) {
...
function makePackage(error: any) {
