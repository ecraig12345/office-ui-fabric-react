...
const PageImageSetBase: React.FunctionComponent<IMarkdownImageSetProps> = props => {
...
export const PageImageSet: React.FunctionComponent<IMarkdownImageSetProps> = styled<
  IMarkdownImageSetProps,
  IMarkdownImageSetStyleProps,
  IMarkdownImageSetStyles
>(PageImageSetBase, getStyles);
