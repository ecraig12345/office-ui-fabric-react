...
import { trackEvent, EventNames, getSiteArea } from '@uifabric/example-app-base/lib/utilities/index';
import { Badge } from '@uifabric/example-app-base/lib/components/Badge/index';
