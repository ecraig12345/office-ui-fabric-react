...
const breadcrumbItems1: IBreadcrumbItem[] = [
...
const breadcrumbItems2: IBreadcrumbItem[] = [
  { text: 'Files', key: 'Files', onClick: _onBreadcrumbItemClicked },
  { text: 'This is folder 1', key: 'f1', onClick: _onBreadcrumbItemClicked },
...
const breadcrumbItems3: IBreadcrumbItem[] = [
...
const breadcrumbItems4: IBreadcrumbItem[] = [
...
const breadcrumbItems5: IBreadcrumbItem[] = [
...
export const BreadcrumbBasicExample: React.FunctionComponent = () => {
  return (
    <div>
      ...
      <Breadcrumb items={breadcrumbItems1} ariaLabel="Breadcrumb with no maxDisplayedItems" overflowAriaLabel="More links" />
      ...
      <Breadcrumb items={breadcrumbItems5} ariaLabel="Current item rendered as a heading" overflowAriaLabel="More links" />
    </div>
  );
};
