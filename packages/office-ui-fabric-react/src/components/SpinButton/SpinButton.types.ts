...
export interface ISpinButtonProps {
  ...
  onValidate?: (
    ...
    defaultOnValidate: (value: string, event: React.SyntheticEvent<HTMLElement>) => string | void
  ) => string | void;
   ...
   * @deprecated Use `onChange` and manually update the `value` prop instead.
   */
  onIncrement?: (value: string, defaultOnIncrement: (value: string) => string | void) => string | void;
   ...
   * @deprecated Use `onChange` and manually update the `value` prop instead.
   */
  onDecrement?: (value: string, defaultOnDecrement: (value: string) => string | void) => string | void;
