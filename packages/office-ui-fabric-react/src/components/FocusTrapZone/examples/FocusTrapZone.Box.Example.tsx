...
export const FocusTrapZoneBoxExample: React.FunctionComponent = () => {
  ...
  return (
    <Stack tokens={outerStackTokens}>
      <Stack.Item>
        <Text>If this button is used to enable FocusTrapZone, focus should return to this button after the FocusTrapZone is disabled.</Text>
      </Stack.Item>
      <Stack.Item>
        <DefaultButton onClick={enableTrapZone} text="Trap Focus" />
      </Stack.Item>
      <FocusTrapZone disabled={!isTrapZoneEnabled}>
