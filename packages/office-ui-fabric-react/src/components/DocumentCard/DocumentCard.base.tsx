...
import { initializeComponentRef, warnDeprecations, classNamesFunction, KeyCodes, getNativeProps, divProperties } from '../../Utilities';
...
export class DocumentCardBase extends React.Component<IDocumentCardProps, any> implements IDocumentCard {
  ...
  constructor(props: IDocumentCardProps) {
    ...
    warnDeprecations('DocumentCard', props, {
