      ...
      return [
        {
          ...
          content: (
            <MarkdownLink href="#/styles/web/colors/products" className={styles.cardLink}>
        ...
        },
        {
          className: styles.card,
          content: (
            <MarkdownLink href="#/styles/web/elevation" className={styles.cardLink}>
              <div className={styles.cardContent}>
        ...
        },
        {
          className: styles.card,
          content: (
            <MarkdownLink href="#/styles/web/icons" className={styles.cardLink}>
              <div className={styles.cardContent}>
        ...
        },
        {
          className: styles.card,
          content: (
            <MarkdownLink href="#/styles/web/layout" className={styles.cardLink}>
              <div className={styles.cardContent}>
        ...
        },
        {
          className: styles.card,
          content: (
            <MarkdownLink href="#/styles/web/motion" className={styles.cardLink}>
              <div className={styles.cardContent}>
        ...
        },
        {
          className: styles.card,
          content: (
            <MarkdownLink href="#/styles/web/typography" className={styles.cardLink}>
              <div className={styles.cardContent}>
        ...
        },
        {
          className: styles.card,
          content: (
            <MarkdownLink href="#/styles/web/localization" className={styles.cardLink}>
              <div className={styles.cardContent}>
