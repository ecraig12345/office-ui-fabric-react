...
const baseUrl = 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Controls/PersonaPage/';
      ...
      return [
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Controls/PersonaPage/docs/ios/PersonaImplementation.md') as string
              }
            </Markdown>
          )
        }
      ...
      return [
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Controls/PersonaPage/docs/android/PersonaImplementation.md') as string
              }
            </Markdown>
          )
        }
