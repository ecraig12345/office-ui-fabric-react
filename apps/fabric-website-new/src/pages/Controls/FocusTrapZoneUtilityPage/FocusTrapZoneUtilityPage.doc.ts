...
const related = require('!raw-loader!@uifabric/fabric-website-new/src/pages/Controls/FocusTrapZoneUtilityPage/docs/FocusTrapZoneUtilityRelated.md') as string;
