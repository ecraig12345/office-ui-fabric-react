      ...
      return [
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Controls/DatePickerPage/docs/ios/DateTimePickerImplementation.md') as string
              }
            </Markdown>
          )
        }
      ...
      return [
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Controls/DatePickerPage/docs/android/DateTimePickerImplementation.md') as string
              }
            </Markdown>
          )
        }
