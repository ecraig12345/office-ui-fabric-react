...
const baseUrl =
  'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/FabricIconsPage/docs';
      ...
      return [
        {
          ...
          content: (
            <Markdown>
              {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/FabricIconsPage/docs/web/FabricIconsUsage.md') as string}
            </Markdown>
          )
        },
