...
const baseUrl =
  'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/ElevationPage/docs';
      ...
      return [
        {
          ...
          content: (
            <>
              <Markdown>
                {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/ElevationPage/docs/web/ElevationDepth.md') as string}
              </Markdown>
        ...
        },
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/ElevationPage/docs/web/ElevationImplementation.md') as string
              }
            </Markdown>
          )
        }
