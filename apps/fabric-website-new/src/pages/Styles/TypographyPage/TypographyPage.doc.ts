...
const related = require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/TypographyPage/docs/TypographyRelated.md') as string;
const componentUrl =
  'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/TypographyPage';

export const TypographyPageProps: TFabricPlatformPageProps = {
  web: {
    title,
    contact: require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/TypographyPage/docs/web/TypographyContact.md') as string,
    related,
    componentUrl
  }
};
