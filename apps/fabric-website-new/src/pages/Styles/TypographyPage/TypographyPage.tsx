...
const baseUrl =
  'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/TypographyPage/docs';
      ...
      return [
        {
          ...
          content: (
            <>
              <Markdown>
                {
                  require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/TypographyPage/docs/web/TypographyWeights.md') as string
                }
              </Markdown>
        ...
        },
        {
          ...
          content: (
            <>
              <Markdown>
                {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/TypographyPage/docs/web/TypographySizes.md') as string}
              </Markdown>
        ...
        },
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/TypographyPage/docs/web/TypographyImplementation.md') as string
              }
            </Markdown>
          )
        }
