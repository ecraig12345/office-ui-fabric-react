...
const visibilityData = require('@uifabric/fabric-website/lib/data/layout-visibility.json');
const breakpointsData = require('@uifabric/fabric-website/lib/data/responsive-breakpoints.json');
