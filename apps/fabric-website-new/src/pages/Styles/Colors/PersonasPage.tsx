...
const baseUrl = 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/Colors/docs';
      ...
      return [
        {
          ...
          content: (
            <>
              <Markdown>
                {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/Colors/docs/web/ColorsPersonas.md') as string}
              </Markdown>
              <ColorPalette
                colors={[
                  {
        ...
        },
        {
          ...
          content: (
            <>
              <Markdown>
                {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/Colors/docs/web/ColorsPersonasGroups.md') as string}
              </Markdown>
              <ColorPalette
                colors={[
                  {
        ...
        },
        {
          ...
          content: (
            <Markdown>
              {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/Colors/docs/web/ColorsImplementation.md') as string}
            </Markdown>
          )
        }
      ];
