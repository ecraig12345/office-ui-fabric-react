...
const baseUrl = 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/MotionPage/docs';
      ...
      return [
        {
          ...
          content: (
            <>
              <Markdown>
                {
                  require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/MotionPage/docs/web/MotionAnimationPatterns.md') as string
                }
              </Markdown>
...

        {
          ...
          content: (
            <>
              <Markdown>
                {
                  require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/MotionPage/docs/web/MotionBasicAnimations.md') as string
                }
              </Markdown>
