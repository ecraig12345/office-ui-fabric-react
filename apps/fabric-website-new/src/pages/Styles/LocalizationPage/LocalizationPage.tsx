...
import { Table } from '@uifabric/fabric-website/lib/components/Table/Table';
...
const baseUrl =
  'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/LocalizationPage/docs';

const directionalIconsData = require('@uifabric/fabric-website/lib/data/directional-icons.json');
const localizedFontsData = require('@uifabric/fabric-website/lib/data/localized-fonts.json');
      ...
      return [
        {
          ...
          content: (
            <Markdown>
              {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/LocalizationPage/docs/web/LocalizationRTL.md')}
            </Markdown>
          )
        },
        {
