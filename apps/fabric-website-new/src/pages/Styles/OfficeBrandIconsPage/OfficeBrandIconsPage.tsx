...
import { IconGrid } from '@uifabric/fabric-website/lib/components/IconGrid/IconGrid';
...
const baseUrl =
  'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Styles/OfficeBrandIconsPage/docs';
...
// @TODO: move this back to external site once the icons list is updated.
const monochromeIcons = require('@uifabric/fabric-website-new/lib/data/brand-icons-monochrome.json');
      ...
      return [
        {
          ...
          content: (
            <>
              <Markdown>
                {
                  require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/OfficeBrandIconsPage/docs/web/OfficeBrandIconsOverview.md') as string
                }
              </Markdown>
              <h3>Product icons</h3>
            ...
            <div className="ms-Grid">
              <div className="ms-Grid-row">
                <div className="ms-Grid-col ms-sm12 ms-lg6">
                  <Markdown>
                    {
                      require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/OfficeBrandIconsPage/docs/web/OfficeBrandIconsFormat.md') as string
                    }
                  </Markdown>
                </div>
                <div className="ms-Grid-col ms-sm12 ms-lg6">
        ...
        },
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/OfficeBrandIconsPage/docs/web/OfficeBrandIconsResolutions.md') as string
              }
            </Markdown>
          )
        },
        {
          ...
          content: (
            <Markdown>
              {
                require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/OfficeBrandIconsPage/docs/web/OfficeBrandIconsImplementation.md') as string
              }
            </Markdown>
          )
        },

        {
          ...
          content: (
            <>
              ...
              <Markdown>
                {
                  require('!raw-loader!@uifabric/fabric-website-new/src/pages/Styles/OfficeBrandIconsPage/docs/web/OfficeBrandIconsSingleColor.md') as string
                }
              </Markdown>
