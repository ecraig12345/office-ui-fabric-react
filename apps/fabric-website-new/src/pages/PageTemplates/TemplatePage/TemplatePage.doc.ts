...
const related = require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/TemplateRelated.md');
...
export const TemplatePageProps: TFabricPlatformPageProps = {
  default: {
    ...
    overview: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateOverview.md') as string,

    // Raw import of best practices Markdown file.
    bestPractices: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateBestPractices.md') as string,

    // Raw import of do's Markdown file.
    dos: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateDos.md') as string,

    // Raw import of don'ts Markdown file.
    donts: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateDonts.md') as string,

    // Raw import of usage guidelines Markdown file.
    usage: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateUsage.md') as string,

    // Raw import of design guidelines Markdown file.
    design: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateDesign.md') as string,

    // Optional title of the generic Markdown section.
    addlContentTitle: 'Markdown Section',

    // Raw import of the generic Markdown file.
    addlContent: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateMarkdown.md') as string,

    // Raw import of the page contact Markdown file.
    contact: require('!raw-loader!@uifabric/fabric-website-new/src/pages/PageTemplates/TemplatePage/docs/default/TemplateContact.md') as string,
