...
const baseUrl = 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/apps/fabric-website-new/src/pages/Overviews/AboutPage/';
  ...
  return [
    {
      ...
      content: (
        <Markdown>
          {require('!raw-loader!@uifabric/fabric-website-new/src/pages/Overviews/AboutPage/docs/default/AboutOverview.md') as string}
        </Markdown>
      )
    }
  ];
